...
#### 2026.3.23)「BET2T77.exeにドロップ出来ない」という症状の出る方がいるようですのでコンソール版「BET2T77_console.exe」を作成しました。
...
2026.3.23 コンソール版「BET2T77_console.exe」を追加。

2026.9.10 独自にT77からBIMファイルに変換できるようT77toBIM.exeを追加。
